...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#07100d] text-[#eef5f0]">
      <div className="border-b border-amber-500/30 bg-amber-500/10 p-3 text-center text-sm">Demonstração com dados fictícios. Nada é salvo ou executado. <Link href="/" className="underline">Voltar aos projetos</Link></div>
